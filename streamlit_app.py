...
try:
  ...
  # REMOVED (just writes the data to the screen)--> streamlit.text(fruityvice_response.json())
...
my_data_rows = my_cur.fetchall() #Previous loading only one row: my_data_row = my_cur.fetchone()
